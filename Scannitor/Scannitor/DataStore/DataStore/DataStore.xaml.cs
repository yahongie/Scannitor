...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		private string _spalsh_screen = string.Empty;

		public string spalsh_screen
		{
			get
			{
				return this._spalsh_screen;
			}
			...
			set
			{
				...
				if (this._spalsh_screen != value)
				{
					this._spalsh_screen = value;
					this.OnPropertyChanged("spalsh_screen");
				}
			}
		}
	}
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/Scannitor;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string spalsh_screen
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.spalsh_screen;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.spalsh_screen = value;
			}
		}
	}
}
